...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Xenim/CocoaAsyncSocket.framework"
  install_framework "Pods-Xenim/CocoaLumberjack.framework"
  ...
  install_framework "Pods-Xenim/XMPPFramework.framework"
fi
